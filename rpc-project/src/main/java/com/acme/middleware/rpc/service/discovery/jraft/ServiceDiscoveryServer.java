...
import com.acme.middleware.rpc.service.discovery.jraft.common.internal.service.discovery.GetServiceInstanceRequestProcessor;
...
public class ServiceDiscoveryServer {
   ...
   public ServiceDiscoveryServer(final String dataPath, final String groupId, final PeerId serverId,
       ...
       //here use name PRC server for raft and business, It also can be seperated generally
    ...
    public static void main(final  String[] args) throws IOException {
        ...
        // start raft server
        final  ServiceDiscoveryServer server = new ServiceDiscoveryServer(dataPath,groupId,serverId,nodeOptions);

        System.out.println("Stated counter server at port:"
